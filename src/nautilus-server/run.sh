...
echo "127.0.0.64   {" >> /etc/hosts
echo "127.0.0.65   "host":" >> /etc/hosts
echo "127.0.0.66   "*"," >> /etc/hosts
echo "127.0.0.67   "port":" >> /etc/hosts
echo "127.0.0.68   "*"" >> /etc/hosts
echo "127.0.0.69   }" >> /etc/hosts
